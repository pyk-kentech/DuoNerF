...
def get_opts():
    ...
    parser.add_argument('--dataset_name', type=str, default='blender',
                        choices=['llff_ray_patch_1image_proj', 'blender_ray_patch_1image_proj',
                                 'blender_ray_patch_1image_rot3d', 'blender_ray_patch_2image_rot3d', 'dtu_proj'],
    ...
    parser.add_argument('--model', type=str,
                        default="sinnerf", choices=['sinnerf', 'duonerf'])
    ...
    parser.add_argument('--ref_indices', nargs=2, type=int, default=None,
                        help='two Blender frame indices used as DuoNeRF front/back references')
    parser.add_argument('--duo_samples_per_epoch', type=int, default=128,
                        help='number of DuoNeRF training samples per epoch')
    parser.add_argument('--duo_random_rays', type=int, default=4096,
                        help='number of random reference rays per DuoNeRF sample')
    parser.add_argument('--duo_pseudo_views', type=int, default=8,
                        help='number of pseudo views per reference used to build depth sampling pool')
