...
from .blender_ray_patch_2image_rot3d import Blender_ray_patch_2image_rot3d_Dataset
...
dataset_dict = {
    ...
    'blender_ray_patch_2image_rot3d': Blender_ray_patch_2image_rot3d_Dataset,
